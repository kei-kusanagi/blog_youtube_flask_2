...
app = Flask(__name__)
app.config["SQLALCHEMY_DATABASE_URI"] = r"sqlite:///C:\Users\folkh\Desktop\python-curse\blog_youtube_flask_2\blog.db"
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
db = SQLAlchemy(app)
app.config["SECRET_KEY"] = "estoesunallavesecreta"
